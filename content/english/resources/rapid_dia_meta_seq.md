...
Nanopore sequencing technology offers a rapid alternative where results can be collected in real time during ongoing analysis. Nanopore sequencing has until recently been limited by a high error rate and a low number of reads not sufficient for sensitive diagnostic mNGS. With recent technical
development these obstacles are now largely overcome enabling mNGS analysis in 24-48h with maintained sensitivity.
