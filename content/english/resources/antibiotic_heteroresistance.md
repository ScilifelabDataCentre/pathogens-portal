...
resource_info:
  ...
  contact: "Dan I. Andersson<br>Medical Biochemistry and Microbiology, Uppsala University<br>Email: [Dan.Andersson@imbim.uu.se](mailto:Dan.Andersson@imbim.uu.se)<br>"
for_background_table:
  pi: Dan I. Andersson
  pi_affiliation: Uppsala University
---

Antibiotic resistance is a major pandemic, associated with ≈ 5 million deaths per year. This has increased the demand for better antibiotic susceptibility testing (AST) methods to maintain therapeutical options and prolong the lifespan of existing antibiotics. Current susceptibility tests miss two critical threats: heteroresistance (HR), where rare mutant sub-clones escape therapy, and the drug-interaction landscape that decides whether an antibiotic pair synergizes or not. Our objective is to eliminate both blind spots by clinically validating two ultra- low-cost, plate-based assays that turn bedside isolates into treatment guidance within 16 h.
