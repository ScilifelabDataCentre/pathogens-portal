...
Many people from SciLifeLab, NBIS, and other organisations were involved in the initial development and content creation for the Swedish COVID-19 Data Portal. An incomplete list of contributors [can be found on Github](https://github.com/ScilifelabDataCentre/covid-portal/graphs/contributors). Since September 2020, the content of the portal is managed by a dedicated team at the [SciLifeLab Data Center](https://scilifelab.se/data/). The data management questions are handled by the data management team at [NBIS](https://nbis.se/). We are happy to answer your questions about data availability, data sharing, data management and all related issues; just send us an email.

<div class="container">
  <div class="row">
    <div class="col-md-2 pt-2">
      <div class="row"><img src="/img/people/ak.jpg" width="150" class="img-thumbnail"/></div>
      <div class="row"><b>Arnold Kochari</b></div>
      <div class="row"><span class="text-muted">Webmaster for the COVID-19 Data Portal, SciLifeLab</span></div>
    </div>
    <div class="col-md-2 pt-2">
      <div class="row"><img src="/img/people/kos.jpeg" width="150" class="img-thumbnail"/></div>
      <div class="row"><b>Katarina Öjefors Stark</b></div>
      <div class="row"><span class="text-muted">Coordinator for COVID-19 projects, SciLifeLab</span></div>
    </div>
    <div class="col-md-2 pt-2">
      <div class="row"><img src="/img/people/pt.jpg" width="150" class="img-thumbnail"/></div>
      <div class="row"><b>Parul Tewatia</b></div>
      <div class="row"><span class="text-muted">Data steward, SciLifeLab</span></div>
    </div>
    <div class="col-md-2 pt-2">
      <div class="row"><img src="/img/people/hk.jpg" width="150" class="img-thumbnail"/></div>
      <div class="row"><b>Hanna Kultima</b></div>
      <div class="row"><span class="text-muted">Data manager, coordinator, SciLifeLab</span></div>
    </div>
    <div class="col-md-2 pt-2">
      <div class="row"><img src="/img/people/jr.jpg" width="150" class="img-thumbnail"/></div>
      <div class="row"><b>Johan Rung</b></div>
      <div class="row"><span class="text-muted">Head of the Data Centre, SciLifeLab</span></div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-2 pt-2">
      <div class="row"><img src="/img/people/pk.jpg" width="150" class="img-thumbnail"/></div>
      <div class="row"><b>Per Kraulis</b></div>
      <div class="row"><span class="text-muted">System development team leader, data engineer, SciLifeLab</span></div>
    </div>
    <div class="col-md-2 pt-2">
      <div class="row"><img src="/img/people/lo.jpg" width="150" class="img-thumbnail"/></div>
      <div class="row"><b>Linus Östberg</b></div>
      <div class="row"><span class="text-muted">Systems developer, system administrator, SciLifeLab</span></div>
    </div>
    <div class="col-md-2 pt-2">
      <div class="row"><img src="/img/people/pe.jpeg" width="150" class="img-thumbnail"/></div>
      <div class="row"><b>Phil Ewels</b></div>
      <div class="row"><span class="text-muted">Bioinformatics development lead, NGI</span></div>
    </div>
    <div class="col-md-2 pt-2">
