...
<div class="plot_wrapper mb-3">
  <div class="table-responsive">{{< plotly json="https://blobserver.dckube.scilifelab.se/blob/FOURTotal_vaccinated_barchart.json" height="500px" >}}</div>
</div>
...
<div class="plot_wrapper mb-3">
  <div class="table-responsive">{{< plotly json="https://blobserver.dckube.scilifelab.se/blob/FOURvaccine_heatmap.json" height="750px" >}}</div>
</div>
