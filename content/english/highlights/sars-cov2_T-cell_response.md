...
* To adhere to data sharing the researchers have made all the data that support the findings of this study were published on [here](https://doi.org/10.1371/journal.pone.0258041.s001) on *SciLifeLab Data Repository* service called [FigShare](https://scilifelab.figshare.com/).
* The *COMMUNITY study* dataset has a [**metadata-record-only**](https://doi.org/10.17044/scilifelab.13567355.v2) set up in FigShare.
* In addition, supplementary tables are available via the fulltext version of the article.
