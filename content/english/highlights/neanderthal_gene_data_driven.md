...
To find out more more about COVID-19 related to Neanderthal biology, see a follow up [Data Highlight from Zeberg *et al.* (2022)](https://covid19dataportal.se/highlights/oas1_splicing_and_severe_covid/). That highlight is related to a later paper from this group entitled ['Multi-ancestry fine mapping implicates OAS1 splicing in risk of severe COVID-19'](https://www.nature.com/articles/s41588-021-00996-8). You can also learn more about the [COVID-19 host genetics initiative](https://www.covid19hg.org/).
