...
Those wishing to submit information about their sample collections to the database should contact ?? (the linked page also contains forms for adding new collections to the database). Questions, comments, or suggestions regarding the database itself can be sent to datacentre@scilifelab.se.
