...
[The Swedish Pathogens Portal](https://www.pathogens.se) aims to make research resources related to infectious disease and pandemic preparedness as Open and FAIR as possible. In the 6 years since its launch, it has proven a valuable resource for the research community. Close collaboration with that community has been key to this success, as the portal was able to adapt to their needs over time.

Recent community engagement efforts (e.g. [a recent survey](https://www.pathogens.se/updates/pathogen_user_survey_results_25/)) have reflected the need for new and improved features on the portal. Some of the needs identified were; easier access to data, more advanced data visualisations, and greater support with data submission.

The Swedish Pathogens Portal needed to be redesigned in a new software in order to effectively meet the current and future needs of the associated research community. A [beta version of the new design has now been made available for testing and feedback](https://swedish-pathogens-portal.scilifelab-2-dev.sys.kth.se/). Later in the year, following iterative improvements, this new design will replace the existing version entirely.

**Explore the [beta version](https://swedish-pathogens-portal.scilifelab-2-dev.sys.kth.se/).**
