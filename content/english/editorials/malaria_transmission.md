...
editorials_authors: [Johan Ankarklev, Ylva Veith, Miren Urrutia Iturritza]
...
In principle, interventions at these stages could stop infection before it is established, prevent parasites from becoming transmissible, and avoid symptoms altogether ([Prudêncio _et al._ (2006)](https://doi.org/10.1038/nrmicro1529), [Mohammed _et al._ (2023)](https://doi.org/10.1128/spectrum.03671-2217)). In practice, however, these same stages have long remained among the most difficult to study. They are brief, clinically silent, and composed of small, heterogeneous parasite populations that are easily missed by traditional experimental approaches. This is where new high-resolution omics and data-driven methods are transforming the field.
