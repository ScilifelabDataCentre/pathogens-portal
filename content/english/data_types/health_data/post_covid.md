...
The data from The Swedish Board of Health and Welfare underlying the below visualisations are primarily generated using the ‘Cause of Death’ administrative register and the Patient Register. The data used on this page is updated monthly, on the second Wednesday of the month, and is available for download [here](https://www.socialstyrelsen.se/statistik-och-data/statistik/statistik-om-covid-19/). Additional data about COVID-19 can be requested from the corresponding registers by any researchers fulfilling the requirements for access, the guidelines for access are available [here](https://bestalladata.socialstyrelsen.se/data-for-forskning/).
